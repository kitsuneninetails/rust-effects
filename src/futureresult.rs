...
//
//impl<'a, X, Y, Z, E> Monoid for FutureResultEffect<'a, E, X, Y, Z>
//    where
//        X: 'a + MonoidEffect + Sync + Send,
//        E: 'a + Sync + Send {
//    type M = ConcreteFutureResult<'a, X, E>;
//    fn empty() -> Self::M {
...
//    type FnctX = X;
//    type FnctY = Y;
//    type FctForX = ConcreteFutureResult<'a, X, E>;
//    type FctForY = ConcreteFutureResult<'a, Y, E>;
...
//        E: 'a + Send + Sync + Debug {
//    type Fnct2Z = Z;
//    type FctForZ = ConcreteFutureResult<'a, Z, E>;
//    fn fmap2(fa: Self::FX,
//             fb: Self::FY,
...
//        Z: 'a + Send + Sync,
//        E: 'a + Send + Sync + Debug {
//    type Fld = ConcreteFutureResult<'a, X, E>;
//    type FldInner = X;
//    type Folded = Y;
//    type Folded2 = ConcreteFutureResult<'a, Y, E>;
//    fn fold(f: Self::Fld,
//            init: Self::Folded,
