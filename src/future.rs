...
//
//impl<'a, X, Y, Z> Monoid for FutureEffect<'a, X, Y, Z>
//    where
//        X: 'a + MonoidEffect + Sync + Send {
//    type M = ConcreteFuture<'a, X>;
//    fn empty() -> Self::M {
...
//    type FnctX = X;
//    type FnctY = Y;
//    type FctForX = ConcreteFuture<'a, X>;
//    type FctForY = ConcreteFuture<'a, Y>;
...
//        Z: 'a + Send + Sync {
//    type Fnct2Z = Z;
//    type FctForZ = ConcreteFuture<'a, Z>;
//    fn fmap2(fa: Self::FX,
//             fb: Self::FY,
...
//        Y: 'a + Send + Sync,
//        Z: 'a + Send + Sync {
//    type Fld = ConcreteFuture<'a, X>;
//    type FldInner = X;
//    type Folded = Y;
//    type Folded2 = ConcreteFuture<'a, Y>;
//    fn fold(f: Self::Fld,
//            init: Self::Folded,
