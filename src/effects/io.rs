...
//        E: 'a + Debug + Send + Sync {}
//
//impl<'a, E: Debug + Send + Sync, X, Y, Z> Monoid for IoEffect<'a, E, X, Y, Z>
//    where
...
//    type FnctX = X;
//    type FnctY = Y;
//    type FctForX = IO<'a, Self::X, E>;
//    type FctForY = IO<'a, Self::Y, E>;
